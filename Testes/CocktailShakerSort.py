...
def salvar_resultados_csv(nome_algoritmo, n, tipo_caso, tempo, memoria):
    ...
    nome_arquivo = 'cocktail_shaker_sort.csv'
...
def main():
    nome_algoritmo = "Cocktail Shaker Sort"
    ...
    for n in tamanhos_n:
        ...
        tempo_melhor, memoria_melhor = medir_tempo_memoria(ordenacao_cocktail_shaker, melhor_caso.copy())
        salvar_resultados_csv(nome_algoritmo, n, "Melhor caso", tempo_melhor, memoria_melhor)

        print("  Pior caso...")
        pior_caso = gerar_pior_caso(n)
        tempo_pior, memoria_pior = medir_tempo_memoria(ordenacao_cocktail_shaker, pior_caso.copy())
        ...
        for i in range(5):
            ...
            tempo, memoria = medir_tempo_memoria(ordenacao_cocktail_shaker, aleatorio.copy())
            tempos.append(tempo)
